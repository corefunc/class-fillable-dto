...
exports.FillableDto = exports.FILLABLE_DTO_OPTIONS_DEFAULT = void 0;
...
class FillableDto {
  ...
  assignDefaults(defaultValues, includeKeys) {
    if (defaultValues && is_object_like_1.checkIsObjectLike(defaultValues)) {
      if (includeKeys) {
  ...
  buildIncludeKeys(includeKeys) {
    ...
    return strings_1.arraySortStrings(keys);
  }
  buildOptions(options) {
    ...
    return {
      class:
        "class" in options && class_validator_1.isBoolean(options["class"])
          ? options["class"]
          : exports.FILLABLE_DTO_OPTIONS_DEFAULT.class,
      prettify:
        "prettify" in options && class_validator_1.isBoolean(options["prettify"])
          ? options["prettify"]
          : exports.FILLABLE_DTO_OPTIONS_DEFAULT.prettify,
      property:
        "property" in options && class_validator_1.isBoolean(options["property"])
          ? options["property"]
          : exports.FILLABLE_DTO_OPTIONS_DEFAULT.property,
      value:
        "value" in options && class_validator_1.isBoolean(options["value"])
          ? options["value"]
