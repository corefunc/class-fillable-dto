...
class FillableDto {
  ...
  toObject() {
    return class_transformer_1.classToPlain(
      clone_marshalling_1.cloneMarshalling(this)
    );
  }
  toString() {
  ...
  buildOptions(options) {
    ...
    return {
      ...
      prettify:
        // @ts-ignore
        "prettify" in options &&
        class_validator_1.isBoolean(options["prettify"])
          ? // @ts-ignore
            options["prettify"]
      ...
      property:
        // @ts-ignore
        "property" in options &&
        class_validator_1.isBoolean(options["property"])
          ? // @ts-ignore
            options["property"]
